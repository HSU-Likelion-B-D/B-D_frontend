  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.titleContainer}>
        <img src={dilly_left} className={styles.main_busy} />
      ...
      <div className={styles.content}>
        ...
        >
          ...
          <div className={styles.proposalPlatform}>
            <div className={styles.proposalPlatformLeft}>
              <input
                type="text"
                placeholder="활동 플랫폼"
                defaultValue={
            ...
            <div className={styles.proposalPlatformRight}>
              <input
                type="text"
                placeholder="콘텐츠 분야"
